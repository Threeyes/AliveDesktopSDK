...
3. 下载最新的[manifest.json](https://raw.githubusercontent.com/Threeyes/AliveDesktopSDK/main/ProjectConfig~/manifest.json)文件（右键点击链接并选择：保存为...），替换`[项目根目录]/Packages`路径下的同名文件。
