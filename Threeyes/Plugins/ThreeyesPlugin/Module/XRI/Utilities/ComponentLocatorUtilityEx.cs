...
namespace Threeyes.XRI
{
    ...
    /// <summary>
    /// Utility methods for locating component instances. (查找并缓存组件)
    /// 
    /// Ref：UnityEngine.XR.Interaction.Toolkit.Utilities.ComponentLocatorUtility
    /// 
    /// PS：因为原工具类为私有，所以只能重新克隆一份
    /// </summary>
    /// <typeparam name="T">The component type.</typeparam>
    public static class ComponentLocatorUtilityEx<T> where T : Component
    {
        /// <summary>
