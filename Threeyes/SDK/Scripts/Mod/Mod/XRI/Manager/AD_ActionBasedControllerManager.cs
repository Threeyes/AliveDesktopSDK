...
/// 
/// Ref: UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets.ActionBasedControllerManager
/// </summary>
//[AddComponentMenu("XR/Action Based Controller Manager")]
[DefaultExecutionOrder(k_UpdateOrder)]
public class AD_ActionBasedControllerManager : MonoBehaviour
{
    /// <summary>
    ...
    //【新增】在选中物体后，临时禁用移动
    public bool IsDisableLocomotionOnRaySelectEnter
    {
        get => m_DisableLocomotionOnRaySelectEnter;
        set { m_DisableLocomotionOnRaySelectEnter = value; }
    }

    public void SetDisableLocomotionOnRaySelectEnter(bool isDisable)
    {
        m_DisableLocomotionOnRaySelectEnter = isDisable;
        if (isDisable)
        {
            DisableLocomotionActions();
        }
    ...
    [SerializeField] bool m_DisableLocomotionOnRaySelectEnter = true;
    void OnRaySelectEntered(SelectEnterEventArgs args)
    {
        if (!m_DisableLocomotionOnRaySelectEnter) return;
    ...
    {
        //退出统一复原，不管m_DisableLocomotionOnRaySelectEnter的值
