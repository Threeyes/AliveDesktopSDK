public static class AD_EditorDefinition
{
    // ——Editor Path
    ///PS:
    ...
    public const string Menu_Root = "Alive Desktop/";
    ...
    public const string MenuElement_Simulator = "Simulator/";
    ...
    public const string MenuElement_XR = "XR/";
    ...
    public const string ComponentMenuPrefix_Root_Mod_Controller_XR = ComponentMenuPrefix_Root_Mod_Controller + MenuElement_XR;
    ...
    public const string HierarchyMenuPrefix_Root_Mod_Controller_XR = Hierarchy_GameObject + ComponentMenuPrefix_Root_Mod_Controller_XR;
    ...
    public const string AssetMenuPrefix_Root_Simulator = AssetMenuPrefix_Root + MenuElement_Simulator;
    ...
    public const string AssetMenuPrefix_Root_Mod_Controller_XR = ComponentMenuPrefix_Root_Mod_Controller_XR;
